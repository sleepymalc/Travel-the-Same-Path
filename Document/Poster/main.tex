...
\title{Travel the Same Path: A Novel TSP solving strategy}
...
\begin{columns}
	...
	\block{Conclusion}{
		...
		With limited computation power and training on small size instances, our result shows a promising performance on the generalization ability of branching, which is a hard
	...
	\block{Future Work}{
		...
		On the other hand, our work should be easy to reproduce and be combined with various standard reinforcement techniques like using better reward functions to further improve our trained model.
	}
\end{columns}
\end{document}